...
| 錯誤 | 正確 |
|------|------|
| **如果有多個 Skill 都用 "review":**<br>`skill-1: description: Review code`<br>`skill-2: description: Review documentation` | **使用更具體的關鍵字:**<br>`skill-1: description: Review source code implementation for bugs and best practices. Keywords: code review, PR review`<br>`skill-2: description: Review technical documentation for clarity and completeness. Keywords: docs review, documentation check` |
