...
| Skill | Description |
|-------|-------------|
| [code-review-claude](./code-review-claude/) | Native code review by Claude (< 30 seconds). Adversarial pass + assumptions list + optional refactored patch. **Default reviewer** (2026-04 benchmark: broader coverage, 0/6 verified hallucinations). |
